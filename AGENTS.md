...
- The `docs/` folder is for developer/contributor information (coding conventions, architechture, etc.). User documentation is maintained in the [wled/WLED-Docs](https://github.com/wled/WLED-Docs) repository.
