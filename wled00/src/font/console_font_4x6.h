 ...
 * [2] Fixed/max glyph width: 4
 // spacing between cars (fixed to 1)
 * [3] Flags: 0x00 (fixed width)
 * [4] First Char: 32
 * [5] Last Char: 126
 * [6-9] Unicode Offset (not used in built in fonts): 0x00000000
 * if variable width flag is set, header is followed by a width table of (Last Char - First Char + 1) bytes containing the width of each glyph
 ...
 *
 * at the end of the stream, padding bits are added if necessary to fill the last byte
 */

static const unsigned char console_font_4x6[] PROGMEM = {
    0x57, 0x06, 0x04, 0x01, 0x00, 0x20, 0x7E, 0x00, 0x00, 0x00, 0x00, // Header: 'W', H, W, Flags, First, Last, UnicodeOffset (32bit)
