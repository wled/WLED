...
[[gnu::hot]] void fast_color_add(uint32_t &c1, uint32_t c2, uint8_t scale = 255) __attribute__((optimize("-O2")));
[[gnu::hot]] void fast_color_scale(uint32_t &c1, uint8_t scale) __attribute__((optimize("-O2")));
