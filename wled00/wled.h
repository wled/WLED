...
WLED_GLOBAL uint32_t      transitionDelay          _INIT(750);    // global transition duration (in ms, max. TRANSITION_MAX_DUR)
WLED_GLOBAL uint32_t      transitionDelayDefault   _INIT(750);    // default transition time (in ms, stored in cfg.json)
