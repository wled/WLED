...
WLED_GLOBAL CRGBW colPri _INIT(0);  // current RGB(W) primary color. colPri should be updated if you want to change the color.
WLED_GLOBAL CRGBW colSec _INIT(0);  // current RGB(W) secondary color
...
WLED_GLOBAL CRGBW colNlT _INIT(0);        // current nightlight color
