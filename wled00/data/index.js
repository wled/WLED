...
function populatePresets(fromls)
{
	...
	for (var key of (arr||[]))
	{
		...
		cn += `<div class="fx-pill-row"><div class="pres lstI" id="p${i}o">`;
...
async function addEffectAsPreset(effectId, effectName) {
	...
	// Capture slider values synchronously before any async operation — reading them
...
// AI: below section was generated by an AI
// Prevent pull-to-refresh when at the top of a scrollable area
var _lastTouchY = 0;
...
document.addEventListener('touchmove', function(e) {
	...
	while (el && el !== document.documentElement) {
		if (el.scrollHeight > el.clientHeight) {
			if (el.scrollTop <= 1 && dy > 0) e.preventDefault();
			return;
		}
		el = el.parentElement;
	}
