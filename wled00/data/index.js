...
function populatePresets(fromls)
{
	...
	if (pNum === 0) {
		gId('pcont').innerHTML = '<p id="noFavsMsg" style="text-align:center;color:#888;padding:32px 16px 0;margin:0;font-size:15px">You have no favorites saved</p>';
...
async function addEffectAsPreset(effectId, effectName) {
	...
	const pal = palInput ? parseInt(palInput.value) : 0;

	list.push({effectId, presetId: nextId, effectName});
	saveFxPresets(list);
	updateFxPresetBtn(effectId, effectName, true);
	showToast("Effect added to favorites!", false, 1000, 'show-green');
	...
	try {
		...
		const presets = Object.assign({}, pJson || {});
...
async function removeEffectPreset(effectId) {
	...
	showToast("Effect removed from favorites!", false, 1000, 'show-green');
