...
- Name: favourites-tab.spec.js >> Empty Favourites state (no fx presets) >> after restore, "You have no favorites saved" message is still shown
- Location: specs\favourites-tab.spec.js:200:3
