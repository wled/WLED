...
Add the AnimatedStaircase_VL53L03X usermod to custom_usermods in the build config or just copy platformio_override.ini.sample to the same folder as platformio.ini
