...
| [`fadeToBlackBy()`](https://github.com/wled/WLED/blob/main/wled00/FX_fcn.cpp)                                          | ---    | can be used to fade all pixels to black using nscale8().  |
